...
const fetchTodo = () => {
  ...
  const mappedTodos = todos.map((todo) => [
   //todoDate(todo.created_on)

    ` <div class="group flex items-center justify-between p-4 mb-4 rounded-md w-full h-16 bg-slate-400 hover:bg-slate-700 text-slate-100 shadow-md">
            <a href="" class="font-bold text-black hover:text-white">${todo.title}<br><span class="text-[9px] text-gray-400">${todoDate(todo.created_on)}</span></a> 
